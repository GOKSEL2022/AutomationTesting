...
public class TC14_BasketItemsCheckOutUpdateBasket {
    ...
    public void BasketItemsCheckOutUpdateBasket() {
        ...
        clickWithJS(allPages.basketPage().textBoxQuantityBasket);
        allPages.basketPage().textBoxQuantityBasket.clear();
        allPages.basketPage().textBoxQuantityBasket.sendKeys("5", Keys.ENTER);
        ...
        assert allPages.basketPage().updateBasketButtonBasket.isDisplayed();
        ...
        clickWithJS(allPages.basketPage().updateBasketButtonBasket);
        assert allPages.basketPage().updateBasketButtonBasket.isDisplayed();
