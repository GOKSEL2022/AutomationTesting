...
public class TC09_ArriwalsAddToBasketItemsCoupon {
    ...
    public void ArriwalsAddToBasketItemsCoupon() {
        ...
        allPages.basketPage().couponCodeBasket.sendKeys("krishnasakinala", Keys.ENTER);
        clickWithJS(allPages.basketPage().applyCouponButtonBasket);
        ...
        assert allPages.basketPage().couponKrishnasakinalaBasket.isDisplayed();
